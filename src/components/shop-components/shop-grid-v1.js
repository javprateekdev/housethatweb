	...
	<div>
			<div className="ltn__product-area ltn__product-gutter mb-100">
              ...
              onChange={(e) => getText(e.target.value)} />
									...
									{
              text && 
              <div style={{}} className='Search' hidden={open}>
                {
                  data.filter(product => product.propertyname.toLowerCase().includes(text.toLowerCase())).map(product => (
                        ...
                        {product.propertyname}
									...
									{data.map((property) => (
										...
										<div className="product-info">
											...
											<h2 className="product-title go-top"><Link to="/product-details">{property.propertyname}</Link></h2>
											<div className="product-img-location">
											<ul>
												<li className="go-top">
												<Link to="/contact"><i className="flaticon-pin" /> {property.address1}</Link>
												</li>
											</ul>
											</div>
								...
								<div className="ltn__product-tab-content-inner ltn__product-list-view">
									...
									{
              text && 
              <div className='Search' hidden={open}>
                {
                  data.filter(product => product.propertyname.toLowerCase().includes(text.toLowerCase())).map(product => (
                    <div className='searchitem'>
                      <Link 

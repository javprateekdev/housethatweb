			      ...
			      <div className="row">
			        <div className="col-md-7">
			          <div className="ltn__top-bar-menu">
			            <ul>
			              <li><a href="mailto:info@webmail.com?Subject=Flower%20greetings%20to%20you"><i className="icon-mail" />enquiry@housethat.co.in</a></li>
			              <li><a href="locations.html"><i class="fa-solid fa-phone-volume" /> +91-96-96-96-8030</a></li>
			            </ul>
			          </div>
			        </div>
			          ...
			          <div className="header-menu d-none d-xl-block go-top">
			            <nav>
			              <div className="ltn__main-menu">
			                <ul>
			                  <li className=""><a href="/home-v3">Home</a>
			                  ...
			                  <li className="special-link">
			                    <Link to="/add-listing">Consult Now</Link>
			                  </li>
							  <li className="special-link">
			                    <Link to="/add-listing">Compare Properties</Link>
			                  </li>
			                </ul>
			              </div>
			            </nav>
			...
			<div id="ltn__utilize-mobile-menu" className="ltn__utilize ltn__utilize-mobile-menu">
				<div className="ltn__utilize-menu-inner ltn__scrollbar">
					...
					<ul>
						...
						<li><Link to="/home-v3">Home Style 01</Link></li>
						</ul>
						</li>
